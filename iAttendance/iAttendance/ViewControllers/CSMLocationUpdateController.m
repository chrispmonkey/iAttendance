...
#define kLabelText [AppDelegate appDelegate].applicationMode == ApplicationModePeripheral ? @"iBeacon Status:" : @"Region Monitoring Status:";
...
- (id)initWithLocationMode:(ApplicationMode)appMode {
    
    self = [super init];
    if (self) {
        [AppDelegate appDelegate].applicationMode = appMode;
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if ([AppDelegate appDelegate].applicationMode == ApplicationModePeripheral) {
